namespace WispDeathBonus
{
    internal class WispDeathBonusConfig
    {
        ...
        {
            GlobalChance = WispDeathBonusPlugin.Instance.Config.Bind<decimal>("General Settings", "Global Proc Chance", 50.00m, "% Chance for Bonus to Generate on Wisp Death").Value;
            ...
            DamageChance = WispDeathBonusPlugin.Instance.Config.Bind<decimal>("Damage Boost Settings", "Damage Boost Chance", 3.00m, "% Chance for Bonus to be a Damage Boost").Value;
            ...
            HealthChance = WispDeathBonusPlugin.Instance.Config.Bind<decimal>("Health Boost Settings", "Health Boost Chance", 5.00m, "% Chance for Bonus to be a Health Boost").Value;
            ...
            HealingChance = WispDeathBonusPlugin.Instance.Config.Bind<decimal>("Healing Boost Settings", "Healing Boost Chance", 35.00m, "% Chance for Bonus to be a Healing Boost").Value;
